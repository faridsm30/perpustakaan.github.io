    ...
    <div class="wrapper">
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="<?= ($title == 'Algoritma') ? 'active' : '' ?>"><a href="<?= base_url('page/algoritma') ?>">Algoritma</a></li>
        ...
        <footer class="main-footer">
            <div class="container">
                ...
                <strong>Copyright &copy; 2023-2024 <a href="">SD SAGA LIFESCHOOL</a>.</strong> All rights
                reserved.
            </div>
            <!-- /.container -->
        </footer>
