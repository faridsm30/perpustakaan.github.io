                            ...
                            foreach ($siswa as $row) : ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-sm btn-warning edit" data-toggle="modal" data-target="#modal-default" data-id="<?= $row['id_anggota']; ?>"><i class="fa fa-edit"></i></button>
                                        <a href="<?= base_url('siswa/delete/' . $row['id_anggota']); ?>" class="btn btn-sm btn-danger" onclick="return confirm('apakah anda yakin?')"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
